...
<html>
    ...
    <body>
      <table style="width:100%">
        ...
        <g:each in="${reservaPermanenteList}" var="reservaPermanente">
          <tr>
              <td>${reservaPermanente.diaDeLaSemana}</td>
              <td>${reservaPermanente.horario}</td>
              <td><g:link controller="cliente" action="show" params="[id:reservaPermanente.cliente.id]">${reservaPermanente.cliente}</g:link></td>
